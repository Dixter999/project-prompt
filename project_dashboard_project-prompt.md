...
- **Documentación**: 118.8% (porcentaje de código documentado)
...
- **dependabot/pip/anthropic-tw-0.51.0**
  - Último commit: N/A
  - Mensaje: N/A
...
#### testing
Baja cobertura de tests (6.064356435643564%). Considera añadir más pruebas.
**Acción recomendada**: Ejecuta 'project-prompt test [módulo]' para generar pruebas unitarias.

#### code_quality
Detectados 101 archivos con alta complejidad: main.py, project_progress_tracker.py y 99 más
