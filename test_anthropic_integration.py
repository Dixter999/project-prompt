...
def main():
    ...
    parser = argparse.ArgumentParser(description='Probar la integración con la API de Anthropic')
    parser.add_argument('--key', help='Clave API de Anthropic')
    parser.add_argument('--setup', action='store_true', help='Configurar la clave API')
    parser.add_argument('--test', action='store_true', help='Probar la integración')
    args = parser.parse_args()
    
    # Si no se especifica ninguna acción, hacer ambas
